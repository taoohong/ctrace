...
var EventsIDToEvent = map[int32]EventConfig{
	...
	Umount2EventID:             {ID: Umount2EventID, ID32Bit: sys32umount2, Name: "umount2", Probes: []probe{{event: "umount2", attach: sysCall, fn: "umount2"}}, Sets: []string{"default", "syscalls", "fs"}},
...
var EventsIDToParams = map[int32][]ArgMeta{
	...
	Umount2EventID:             {{Type: "const char*", Name: "target"}, {Type: "int", Name: "flags"}},
